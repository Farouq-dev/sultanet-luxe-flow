...
function About() {
  return (
    <div className="mx-auto max-w-4xl px-4 pb-16 pt-16 sm:px-6 sm:pb-24 sm:pt-28">
      <Reveal>
        <p className="text-xs font-medium uppercase tracking-[0.28em] text-muted-foreground">Our story</p>
        <h1 className="mt-3 font-display text-3xl sm:text-5xl leading-[1.05] sm:text-7xl">Wellness, without noise.</h1>
      </Reveal>
      <Reveal delay={0.15}>
      ...
      <div className="mt-8 grid sm:mt-16 gap-8 sm:grid-cols-3">
        {[
          ...
          <Reveal key={s.l}>
            <div className="rounded-3xl border border-border bg-card p-8">
              <div className="font-display text-3xl sm:text-5xl text-gradient">{s.n}</div>
